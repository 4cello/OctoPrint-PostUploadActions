...
class PostuploadactionsPlugin(octoprint.plugin.SettingsPlugin,
...
__plugin_name__ = "Postuploadactions Plugin"
...
def __plugin_load__():
    ...
    __plugin_implementation__ = PostuploadactionsPlugin()
